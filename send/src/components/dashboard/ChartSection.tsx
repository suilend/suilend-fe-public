      ...
      <CardHeader>
           ...
           <div className="flex items-center gap-5">
             ...
             <Select value={selectedProtocol} onValueChange={setSelectedProtocol}>
               ...
               <span className="text-muted-foreground font-sans">Protocol:</span>
                 <span className="font-sans">
                 {toTitleCase(selectedProtocol)}
                 </span>
               </SelectTrigger>
               <SelectContent>
                 <SelectItem value="all"><span className="font-sans">All</span></SelectItem>
                 <SelectItem value="suilend"><span className="font-sans">Suilend</span></SelectItem>
                 <SelectItem value="steamm"><span className="font-sans">STEAMM</span></SelectItem>
               </SelectContent>
             </Select>
           </div>
         </div>
